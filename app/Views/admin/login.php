...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="/stisla-master/node_modules/bootstrap-social/bootstrap-social.css">
    ...
    <div id="app">
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="/stisla-master/assets/img/unsplash/login-bg.jpg">
