...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            ...
            <form action="<?= base_url('/exp/save/'); ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            <label>Posisi</label>
                            <input type="text" autofocus class="form-control <?= ($validation->hasError('posisi') ? 'is-invalid' : ''); ?>" id="posisi" name="posisi" value="<?= old('posisi'); ?>">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>Periode</label>
                            <input type="text" autofocus class="form-control <?= ($validation->hasError('periode') ? 'is-invalid' : ''); ?>" id="periode" name="periode" value="<?= old('periode'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" autofocus class="form-control <?= ($validation->hasError('deskripsi') ? 'is-invalid' : ''); ?>" id="deskripsi" name="deskripsi" value="<?= old('deskripsi'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-9">
                            <img src="/img/exp/default.png" class="img-preview1 avapreview">
